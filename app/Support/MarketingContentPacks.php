 ...
 *
 * Copy uses British English. Links use the standard query shape:
 * https://www.practisbase.com/{path}?utm_source=linkedin&utm_medium=social&utm_campaign={pack-id}
...
class MarketingContentPacks
{
    ...
    public static function all(): array
    {
        ...
        $packs = [
            ...
            [
                'id' => 'death-to-excel',
                'label' => 'Death to Excel',
                'channel' => 'LinkedIn',
                'theme' => 'financial-chart',
                'ready' => true,
                'kicker' => 'For all sole traders',
                'headline' => 'Death to Excel for invoices and VAT.',
                ...
                'caption' => "Managing invoices and VAT in Excel is dangerous and slow.\n\n"
                ...
                'tip' => 'Screenshot Overview or ledger next to a (blank) spreadsheet meme — keep it professional.',
                'url_path' => '/',
            ],
            [
                'id' => 'bca-compliance',
            ...
            [
                ...
                'tip' => 'Film phone + Download app / Add to Home Screen, then open a condition report form.',
                'url_path' => '/',
            ],
            [
            ...
            [
                ...
                'caption' => "Apply your official professional warrant stamp to digital documents with zero friction.\n\n"
                    ."PractisBase includes a stamper workflow for periti and engineers so signed/stamped PDFs leave your desk cleanly — not as a scan of a wet stamp on a kitchen counter.\n\n"
                    .'{url}',
            ...
            [
                ...
                'highlight' => 'Cerulean Labs Ltd · Malta',
                'cta' => 'Join PractisBase',
                'caption' => "Generic foreign software does not know Maltese law.\n\n"
                    ."PractisBase is built here, for you — sole-trader fiscal reality, profession desks, and local spelling of how work actually gets done in Malta.\n\n"
                    .'{url}',
                'hashtags' => '#BuiltInMalta #MaltaTech #SoleTrader #CeruleanLabs #PractisBase',
                'tip' => 'Use as a brand/community post; pair with Founding graphic if seats remain.',
                'url_path' => '/',
            ],
        ];
