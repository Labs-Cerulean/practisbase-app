...
class TenantStorage
{
    ...
    public static function architectConditionReportsPath(int $userId): string
    {
        return 'tenants/' . $userId . '/architect/condition-reports';
    }

    public static function architectMethodStatementsPath(int $userId): string
    {
        return 'tenants/' . $userId . '/architect/method-statements';
    }
    ...
    public static function engineerReportsPath(int $userId): string
    {
        return 'tenants/' . $userId . '/engineer/reports';
    }
