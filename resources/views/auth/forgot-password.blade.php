...
<head>
    ...
    <title>Forgot Password | PractisBase</title>
    ...
    <style>
        ...
        .alert-success { background-color: #ecfdf5; border: 1px solid #a7f3d0; color: #065f46; padding: 1rem; border-radius: var(--radius-md); margin-bottom: 1.5rem; font-size: 0.85rem; line-height: 1.45; }
...
<body>
    <div class="auth-card">
        <div class="auth-header">
            ...
            <h2 style="color: var(--primary-navy); margin-bottom: 0.25rem;">Forgot password</h2>
            <p style="color: var(--text-muted); font-size: 0.95rem; line-height: 1.45; margin: 0;">
                Enter your account email. If it matches an account, we will send reset instructions.
            </p>
        </div>
