...
<head>
    ...
    <style>
        ...
        .rx-body { border: 1.5px solid #0f172a; padding: 16px; margin-top: 10px; min-height: 160px; }
        .rx-title { font-size: 13px; font-weight: bold; margin-bottom: 10px; }
...
<body>
    ...
    <div class="rx-banner">Prescription · for pharmacy / patient copy</div>
    ...
    <div class="rx-body">
        ...
        <div class="rx-title">{{ $entryPayload['title'] ?? '' }}</div>
