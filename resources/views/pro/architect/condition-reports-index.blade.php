...
@section('content')
    <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 1rem; flex-wrap: wrap; margin-bottom: 1.25rem;">
        <div>
            ...
            <p style="margin: 0; color: var(--text-muted); font-size: 0.9rem;">Neighbour / third-party condition reports (Seventh Schedule) — one builder, stampable PDF.</p>
        </div>
    ...
    @if($reports->isEmpty())
        <div style="padding: 3rem; border: 2px dashed var(--border-light); border-radius: var(--radius-md); text-align: center; background: white;">
            ...
            <a href="/pro/architect/condition-reports/create" style="color: #3f6212; font-weight: 700; text-decoration: none;">Build your first report</a>
        </div>
    @else
