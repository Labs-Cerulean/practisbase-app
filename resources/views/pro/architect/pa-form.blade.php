        ...
        <div style="display: grid; gap: 0.85rem;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.85rem;">
                ...
                <div>
                    ...
                    <div style="font-size: 0.72rem; color: var(--text-muted); margin-top: 0.25rem;">First day physical works under this permit began. Demolition / excavation / construction dates belong on the method statement.</div>
                </div>
            </div>
            <div>
