...
@section('content')
    <div style="margin-bottom: 1.25rem;">
        <a href="{{ $client ? '/pro/architect/clients/'.$client->id : '/pro/architect/clients' }}" style="color: var(--text-muted); text-decoration: none; font-weight: 600;">← Back</a>
    ...
    <form method="POST" action="{{ $client ? '/pro/architect/clients/'.$client->id : '/pro/architect/clients' }}" style="background: white; border: 1px solid var(--border-light); border-radius: var(--radius-lg); padding: 1.35rem; box-shadow: var(--shadow-sm); max-width: 720px;">
        @csrf
        ...
        <div style="display: grid; gap: 0.85rem;">
            ...
            <button type="submit" style="background: #3f6212; color: white; border: none; padding: 0.75rem 1.1rem; border-radius: var(--radius-md); font-weight: 700; cursor: pointer; width: fit-content;">Save client</button>
        </div>
    </form>
@endsection
