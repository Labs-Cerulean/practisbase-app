...
@section('page_title', 'Architect DMS')

@section('content')
    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 1.5rem; gap: 1rem;">
        <div>
            <h1 style="margin: 0 0 0.25rem; color: var(--primary-navy); font-size: 1.5rem;">Architect DMS</h1>
            <p style="margin: 0; color: var(--text-muted); font-size: 0.9rem;">Project phases shell — BCA method-statement templates to be locked with domain expert.</p>
        </div>
        <a href="/pro/architect/projects/create" style="background: var(--primary-cerulean); color: white; padding: 0.55rem 1rem; border-radius: var(--radius-md); font-weight: 600; text-decoration: none;">+ Project</a>
    </div>
    @if(session('success'))
