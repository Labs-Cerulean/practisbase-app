...
@section('content')
    ...
    @if($reports->isEmpty())
        <div style="padding: 3rem; border: 2px dashed var(--border-light); border-radius: var(--radius-md); text-align: center; background: white;">
            ...
            <a href="/pro/engineer/reports/create{{ $projectId ? '?project_id='.$projectId : '' }}" style="color: var(--primary-cerulean); font-weight: 700; text-decoration: none;">Choose a project &amp; build a report</a>
        </div>
    @else
