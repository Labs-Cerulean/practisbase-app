...
@section('page_title', 'New Certification')
...
@section('content')
    <div style="max-width: 640px; margin: 0 auto; background: white; border: 1px solid var(--border-light); border-radius: var(--radius-lg); padding: 2rem; box-shadow: var(--shadow-sm);">
        <div style="display: flex; justify-content: space-between; margin-bottom: 1.25rem;">
            <h2 style="margin: 0; color: var(--primary-navy);">Log certification</h2>
            <a href="/pro/engineer/certifications" style="color: var(--text-muted); font-weight: 600; text-decoration: none;">Cancel</a>
        </div>
        @if($errors->any())
        ...
        @endif
        <form action="/pro/engineer/certifications" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div style="margin-bottom: 1rem;">
                <label style="display: block; font-weight: 600; margin-bottom: 0.4rem;">Subject / site</label>
            ...
            <div style="margin-bottom: 1rem;">
                <label style="display: block; font-weight: 600; margin-bottom: 0.4rem;">Photo <span style="font-weight: 500; color: var(--text-muted);">(optional, R2)</span></label>
            ...
            <button type="submit" style="width: 100%; padding: 0.85rem; background: var(--primary-cerulean); color: white; border: none; border-radius: var(--radius-md); font-weight: 700; cursor: pointer;">Save certification</button>
        </form>
    </div>
@endsection
